...
Aplikasi berbasis CLI Python untuk pemesanan tiket bioskop dengan sistem antrean (queue) dan linked list
...
2. create virtual enviroment **python -m venv venv** and activate venv
